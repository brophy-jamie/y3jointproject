...
echo "<b>AS YOU HAVE SELECTED YES FOR ONE OF THE OPTIONS PLEASE ENSURE TO IMMEDIATELY SELF-ISOLATE</b>","<br>";
	...
	$sql = "INSERT INTO patientrecords (firstName,surname,DateOfBirth,Practitioner,MedCard,covidq1,covidq2,covidq3,covidq4,covidq5) VALUES ('$content_hex', '$content_hex1', '$content_hex2', '$content_hex3', '$content_hex4', '$content_hex5', '$content_hex6', '$content_hex7', '$content_hex8', '$content_hex9')";
